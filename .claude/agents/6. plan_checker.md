...
spec, plan 문서는 /docs/usecases/00N/spec.md, /docs/usecases/00N/plan.md or /docs/pages/[pagename]/plan.md 경로에 있다.
...
모든 과정이 완료되었다면, 같은 경로에 plan-check-report.md 파일을 생성하고, 그 안에 최종 결과 보고서를 적는다.