// AUTO-GENERATED by mcp__supabase__generate_typescript_types (techstack.md §7).
// 재생성: 마이그레이션 적용 후 mcp__supabase__generate_typescript_types로 이 파일을 덮어쓴다.
// 수동 편집 금지 — 각 기능의 schema.ts(Zod)가 이 타입을 참고해 런타임 검증 스키마를 별도 정의한다.
export type Json =
  | string
  | number
  | boolean
