/**
 * 랜딩페이지 카피/콘텐츠 상수 (SOT).
 * PRD §1(핵심 목표)·§3(포함 페이지)에서 도출한 서비스 강점을 DESIGN.md §10 보이스
 * (선언적·절제·과장 금지)로 정리한다.
 * 문자열 하드코딩 금지 — 랜딩 프레젠터는 모두 이 상수를 순회해 렌더한다.
 */

/** 히어로 상단 배지 */
export const HERO_EYEBROW = "KRX · US 상장기업 밸류체인 데이터";

/** 히어로 헤드라인(2줄 구성 — 두 번째 줄은 액센트 강조) */
export const HERO_TITLE_LEAD = "산업의 흐름을";
export const HERO_TITLE_ACCENT = "한 장의 마인드맵으로";

export const HERO_SUBTITLE =
  "소재부터 완성품까지, 기업을 노드로 잇고 관계를 엣지로 그립니다. 가치총액·매출 추이·과거 시점을 한 화면에서 탐색합니다.";
...
/** 핵심 기능 섹션 카드 (PRD 핵심 목표 매핑) — tone은 토큰 2종(data/accent)만 사용 */
...
/** 하단 최종 CTA */
export const FINAL_CTA_TITLE = "산업의 지도를 펼쳐보세요";
export const FINAL_CTA_SUBTITLE =
  "로그인 없이 공식 밸류체인과 기업 상세를 열람할 수 있습니다. 직접 만들고 저장하려면 가입이 필요합니다.";
