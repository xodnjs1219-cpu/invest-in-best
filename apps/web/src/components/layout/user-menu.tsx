...
export function UserMenu({ email, role, isLoggingOut, onLogout }: UserMenuProps) {
  return (
    <div className="flex items-center gap-3" aria-label={AUTH_LOGOUT_MESSAGES.menuLabel}>
      ...
      <button type="button" onClick={onLogout} disabled={isLoggingOut} className="text-sm underline">
